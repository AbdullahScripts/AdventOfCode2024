...
# Read the initial stones from input file
...
print("Part One - Number of stones after 25 blinks:", stones_after_25_blinks)

# Part Two: 75 blinks
stones_after_75_blinks = simulate_blinks(initial_stones, 75)
print("Part Two - Number of stones after 75 blinks:", stones_after_75_blinks)